...
class Recall:
    ...
    def top_k_items(self, query):
        ...
        print('cand', cand)
        cand = sorted(cand, key=lambda x: np.linalg.norm(self.data[x]-query), reverse = True)
        print('sorted cand', cand)
